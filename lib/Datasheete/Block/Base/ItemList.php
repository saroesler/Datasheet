 ...
 */
class Datasheete_Block_Base_ItemList extends Zikula_Controller_AbstractBlock
{
    /**
    ...
    {
        SecurityUtil::registerPermissionSchema('Datasheete:ItemListBlock:', 'Block title::');
    }
    ...
    public function info()
    {
        ...
        if (!ModUtil::available('Datasheete')) {
            $requirementMessage .= $this->__('Notice: This block will not be displayed until you activate the Datasheete module.');
        }
    
        return array('module'          => 'Datasheete',
                     'text_type'       => $this->__('Datasheete list view'),
                     'text_type_long'  => $this->__('Display list of Datasheete objects.'),
                     'allow_multiple'  => true,
                     'form_content'    => false,
                     'form_refresh'    => false,
                     'show_preview'    => true,
    ...
    public function display($blockinfo)
    {
        ...
        if (!SecurityUtil::checkPermission('Datasheete:ItemListBlock:', "$blockinfo[title]::", ACCESS_OVERVIEW)) {
            return false;
        }
        ...
        ModUtil::initOOModule('Datasheete');
        ...
        $entityClass = 'Datasheete_Entity_' . ucwords($objectType);
        ...
        list($entities, $objectCount) = ModUtil::apiFunc('Datasheete', 'selection', 'getEntitiesPaginated', $selectionArgs);
        ...
        if (empty($blockinfo['title'])) {
            $blockinfo['title'] = $this->__('Datasheete items');
        }
    ...
    protected function getSortParam($vars, $repository)
    {
        ...
        if ($vars['sorting'] == 'newest') {
            $idFields = ModUtil::apiFunc('Datasheete', 'selection', 'getIdFields', array('ot' => $vars['objectType']));
            if (count($idFields) == 1) {
    ...
    public function update($blockinfo)
    {
        ...
        $vars['objectType'] = $this->request->request->filter('objecttype', 'datasheet', FILTER_SANITIZE_STRING);
