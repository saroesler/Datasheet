 ...
 */
class Datasheete_Listener_ModuleDispatch extends Datasheete_Listener_Base_ModuleDispatch
{
    /**
    ...
    public static function serviceLinks(Zikula_Event $event)
    {
        ...
        // Format data like so:
        // $event->data[] = array('url' => ModUtil::url('Datasheete', 'user', 'main'), 'text' => __('Link Text'));
    }
}
