 ...
 */
class Datasheete_Listener_Base_User
{
    /**
    ...
    public static function delete(Zikula_Event $event)
    {
        ...
        $repo = $entityManager->getRepository('Datasheete_Entity_Datasheet');
        // delete all datasheets created by this user
        $repo->deleteCreator($uid);
        // note you could also do: $repo->updateCreator($uid, 2);
        
        // set last editor to admin (2) for all datasheets updated by this user
