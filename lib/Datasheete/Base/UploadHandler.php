 ...
 */
class Datasheete_Base_UploadHandler
{
    /**
    ...
    {
        $this->allowedObjectTypes = array('datasheet');
        ...
        $this->allowedFileSizes = array('datasheet' => array('datasheet' => 0));
    }
    ...
    protected function isAllowedFileExtension($objectType, $fieldName, $extension)
    {
        ...
        switch ($objectType) {
            case 'datasheet':
                $allowedExtensions = array('gif', 'jpeg', 'jpg', 'png', 'pdf', 'doc', 'docx', 'odt', 'xls', 'ods');
                    break;
        }
