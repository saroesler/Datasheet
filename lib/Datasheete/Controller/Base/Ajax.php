 ...
 */
class Datasheete_Controller_Base_Ajax extends Zikula_Controller_AbstractAjax
{
    ...
    public function getItemListFinder(array $args = array())
    {
        ...
        if ($this->request->isPost() && $this->request->request->has('ot')) {
            $objectType = $this->request->request->filter('ot', 'datasheet', FILTER_SANITIZE_STRING);
        } elseif ($this->request->isGet() && $this->request->query->has('ot')) {
            $objectType = $this->request->query->filter('ot', 'datasheet', FILTER_SANITIZE_STRING);
        }
        ...
        $entityClass = 'Datasheete_Entity_' . ucfirst($objectType);
