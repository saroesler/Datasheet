 ...
 */
class Datasheete_ContentType_Base_Item extends Content_AbstractContentType
{
    ...
    public function getTitle()
    {
        ...
        return __('Datasheete detail view', $dom);
    }
    ...
    public function getDescription()
    {
        ...
        return __('Display or link a single Datasheete object.', $dom);
    }
    ...
    public function display()
    {
        if ($this->id != null && !empty($this->displayMode)) {
            return ModUtil::func('Datasheete', 'external', 'display', $this->getDisplayArguments());
        }
