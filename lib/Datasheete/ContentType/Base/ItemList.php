 ...
 */
class Datasheete_ContentType_Base_ItemList extends Content_AbstractContentType
{
    /**
    ...
    public function getTitle()
    {
        ...
        return __('Datasheete list view', $dom);
    }
    ...
    public function getDescription()
    {
        ...
        return __('Display list of Datasheete objects.', $dom);
    }
    ...
    public function display()
    {
        ...
        $this->view->toplevelmodule = 'Datasheete';
    
        $this->view->setCaching(Zikula_View::CACHE_ENABLED);
        // set cache id
        $component = 'Datasheete:' . ucwords($this->objectType) . ':';
        $instance = '::';
    ...
    protected function getSortParam($repository)
    {
        ...
        if ($this->sorting == 'newest') {
            $idFields = ModUtil::apiFunc('Datasheete', 'selection', 'getIdFields', array('ot' => $this->objectType));
            if (count($idFields) == 1) {
    ...
    {
        return array('objectType' => 'datasheet',
                     'sorting' => 'default',
                     'amount' => 1,
    ...
    public function startEditing()
    {
        ...
        array_push($this->view->plugins_dir, 'modules/Datasheete/templates/plugins');
    }
}
