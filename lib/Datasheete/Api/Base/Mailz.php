 ...
 */
class Datasheete_Api_Base_Mailz extends Zikula_AbstractApi
{
    /**
    ...
    public function getPlugins(array $args = array())
    {
        ...
        $plugins[] = array(
            'pluginid'      => 1,
            'module'        => 'Datasheete',
            'title'         => $this->__('3 newest datasheets'),
            'description'   => $this->__('A list of the three newest datasheets.')
        );
        $plugins[] = array(
            'pluginid'      => 2,
            'module'        => 'Datasheete',
            'title'         => $this->__('3 random datasheets'),
            'description'   => $this->__('A list of three random datasheets.')
        );
        return $plugins;
    }
    ...
    public function getContent(array $args = array())
    {
        ...
        $idFields = ModUtil::apiFunc('Datasheete', 'selection', 'getIdFields', array('ot' => $objectType));
