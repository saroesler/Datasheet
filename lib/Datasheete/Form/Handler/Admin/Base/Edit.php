 ...
 */
class Datasheete_Form_Handler_Admin_Base_Edit extends Zikula_Form_AbstractHandler
{
    /**
    ...
    public function initialize(Zikula_Form_View $view)
    {
        ...
        $controllerHelper = new Datasheete_Util_Controller($this->view->getServiceManager());
    ...
    protected function writeRelationDataToEntity_rec($entity, $entityData, $plugins)
    {
        foreach ($plugins as $plugin) {
            if ($plugin instanceof Datasheete_Form_Plugin_AbstractObjectSelector && method_exists($plugin, 'assignRelatedItemsToEntity')) {
    ...
    {
        foreach ($plugins as $plugin) {
            if ($plugin instanceof Datasheete_Form_Plugin_AbstractObjectSelector && method_exists($plugin, 'persistRelatedItems')) {
