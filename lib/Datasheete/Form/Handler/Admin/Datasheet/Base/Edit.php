 ...
 * It aims on the datasheet object type.
 *
 * More documentation is provided in the parent class.
 */
class Datasheete_Form_Handler_Admin_Datasheet_Base_Edit extends Datasheete_Form_Handler_Admin_Edit
{
    /**
     * Pre-initialise hook.
     *
    ...
    public function preInitialize()
    {
        ...
        $this->objectType = 'datasheet';
        $this->objectTypeCapital = 'Datasheet';
        $this->objectTypeLower = 'datasheet';

        $this->hasPageLockSupport = true;
        // array with upload fields and mandatory flags
        $this->uploadFields = array('datasheet' => true);
    ...
    public function initialize(Zikula_Form_View $view)
    {
        ...
        if (count($this->listFields) > 0) {
            $helper = new Datasheete_Util_ListEntries($this->view->getServiceManager());
    ...
    {
        // redirect to the list of datasheets
        $viewArgs = array('ot' => $this->objectType);
        $url = ModUtil::url($this->name, 'admin', 'view', $viewArgs);
    
        if ($args['commandName'] != 'delete' && !($this->mode == 'create' && $args['commandName'] == 'cancel')) {
            // redirect to the detail page of treated datasheet
            $url = ModUtil::url($this->name, 'admin', 'display', array('ot' => 'datasheet', 'id' => $this->idValues['id']));
        }
    ...
    protected function getDefaultMessage($args, $success = false)
    {
        ...
        switch ($args['commandName']) {
            case 'submit':
                        if ($this->mode == 'create') {
                            $message = $this->__('Done! Datasheet created.');
                        } else {
                            $message = $this->__('Done! Datasheet updated.');
                        }
                        break;
            case 'delete':
                        $message = $this->__('Done! Datasheet deleted.');
                        break;
            default:
                        $message = $this->__('Done! Datasheet updated.');
                        break;
    ...
    public function applyAction(array $args = array())
    {
        ...
        try {
            ...
            $workflowHelper = new Datasheete_Util_Workflow($this->view->getServiceManager());
