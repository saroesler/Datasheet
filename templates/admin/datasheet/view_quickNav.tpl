{* purpose of this template: datasheets view filter form in admin area *}
{checkpermissionblock component='Datasheete:Datasheet:' instance='::' level='ACCESS_EDIT'}
{assign var='objectType' value='datasheet'}
<form action="{$modvars.ZConfig.entrypoint|default:'index.php'}" method="get" id="datashDatasheetQuickNavForm" class="datashQuickNavForm">
    <fieldset>
        <h3>{gt text='Quick navigation'}</h3>
        <input type="hidden" name="module" value="{modgetinfo modname='Datasheete' info='displayname'}" />
...
/* <![CDATA[ */
    document.observe('dom:loaded', function() {
        datashInitQuickNavigation('datasheet', 'admin');
