...
<div class="z-formrow">
    <label for="Datasheete_objecttype">{gt text='Object type'}:</label>
    <select id="Datasheete_objecttype" name="objecttype" size="1">
        <option value="datasheet"{if $objectType eq 'datasheet'} selected="selected"{/if}>{gt text='Datasheets'}</option>
    </select>
...
{if $properties ne null && is_array($properties)}
    ...
    {foreach item='propertyName' from=$properties}
        <div class="z-formrow">
            ...
            &nbsp;
            {selector_category name="`$categorySelectorName``$propertyName`" field='id' selectedValue=$catIds.$propertyName categoryRegistryModule='Datasheete' categoryRegistryTable=$objectType categoryRegistryProperty=$propertyName defaultText=$lblDefault editLink=false multipleSize=$categorySelectorSize}
...
<div class="z-formrow">
    <label for="Datasheete_sorting">{gt text='Sorting'}:</label>
    <select id="Datasheete_sorting" name="sorting">
...
<div class="z-formrow">
    <label for="Datasheete_amount">{gt text='Amount'}:</label>
    <input type="text" id="Datasheete_amount" name="amount" size="10" value="{$amount|default:"5"}" />
</div>

<div class="z-formrow">
    <label for="Datasheete_template">{gt text='Template'}:</label>
    <select id="Datasheete_template" name="template">
...
<div id="customtemplatearea" class="z-formrow z-hide">
    <label for="Datasheete_customtemplate">{gt text='Custom template'}:</label>
    <input type="text" id="Datasheete__customtemplate" name="customtemplate" size="40" maxlength="80" value="{$customTemplate|default:''}" />
    <div class="z-sub z-formnote">{gt text='Example'}: <em>itemlist_{objecttype}_display.tpl</em></div>
</div>

<div class="z-formrow z-hide">
    <label for="Datasheete_filter">{gt text='Filter (expert option)'}:</label>
    <input type="text" id="Datasheete_filter" name="filter" size="40" value="{$filterValue|default:''}" />
