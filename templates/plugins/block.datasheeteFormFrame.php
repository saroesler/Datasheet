...
/**
 * The datasheeteFormFrame plugin adds styling <div> elements and a validation summary.
 *
 ...
 */
function smarty_block_datasheeteFormFrame($params, $content, $view)
{
    ...
    $result .= $view->registerBlock('Datasheete_Form_Plugin_FormFrame', $params, $content);
